Data.set('weapons', Weapon, [
	...
	// Armes de Jet
	{id: 11, name: "Couteau de jet", group:"Armes de Jet", associatedComp:"agility", bonusBase:-1, bonusSpe:"", attributs:{ label: "Portée 10M, Rapide"}},
	{id: 12, name: "Filet", group:"Armes de Jet", associatedComp:"", bonusBase:1, bonusSpe:"", attributs:{ label: "Portée 10M, Empêtrement (pas de dégats)"}},
	{id: 13, name: "Foëne de jet", group:"Armes de Jet", associatedComp:"agility", bonusBase:1, bonusSpe:"", attributs:{ label: "Portée 10M"}},
	{id: 14, name: "Fronde", group:"Armes de Jet", associatedComp:"athl", bonusBase:-1, bonusSpe:"", attributs:{ label: "Portée 100m"}},
	{id: 15, name: "Hachette de jet", group:"Armes de Jet", associatedComp:"athl", bonusBase:0, bonusSpe:"", attributs:{ label: "Portée 10M"}},
	{id: 16, name: "Javeline", group:"Armes de Jet", associatedComp:"athl", bonusBase:0, bonusSpe:"", attributs:{ label: "Portée 10M"}},
	...
	{id: 25, name: "Fléau D'armes", group:"Casse-tête", associatedComp:"athl", bonusBase:3, bonusSpe:"force", attributs:{ label: "Puissante, Fracassante 1, 2 Mains"}},
	{id: 26, name: "Trique/Gourdin", group:"Casse-tête", associatedComp:"athl", bonusBase:-1, bonusSpe:"", attributs:{ label: "Secondaire +1"}},
	{id: 27, name: "Maillet", group:"Casse-tête", associatedComp:"athl", bonusBase:1, bonusSpe:"", attributs:{ label: "Encombrante 1, Fracassante 1, Lente, Assomante, 2 Mains"}},
	{id: 28, name: "Marteau de Guerre", group:"Casse-tête", associatedComp:"athl", bonusBase:0, bonusSpe:"force", attributs:{ label: "Encombrante 1, Puissante, Fracassante 2, Lente, 2 Mains"}},
	{id: 29, name: "Masse d'Armes", group:"Casse-tête", associatedComp:"athl", bonusBase:0, bonusSpe:"", attributs:{ label: "-"}},
	{id: 30, name: "Morgenstern", group:"Casse-tête", associatedComp:"athl", bonusBase:0, bonusSpe:"", attributs:{ label: "Fracassante 1, Hargneuse"}},
	// Escrime
	{id: 31, name: "Épée Braavosi", group:"Escrime", associatedComp:"agility", bonusBase:0, bonusSpe:"", attributs:{ label: "Déf. +1, Rapide"}},
	{id: 32, name: "Épée Courte", group:"Escrime", associatedComp:"agility", bonusBase:-1, bonusSpe:"", attributs:{ label: "Rapide"}},
	{id: 33, name: "Main Gauche", group:"Escrime", associatedComp:"agility", bonusBase:-1, bonusSpe:"", attributs:{ label: "Déf. +2, Secondaire +1"}},
	// Haches
	{id: 34, name: "Bec de Corbin", group:"Casse-tête", associatedComp:"athl", bonusBase:-1, bonusSpe:"", attributs:{ label: "Fracassante 1"}},
	{id: 35, name: "Cognée", group:"Haches", associatedComp:"athl", bonusBase:1, bonusSpe:"", attributs:{ label: "2 Mains"}},
	{id: 36, name: "Hache de bataille", group:"Haches", associatedComp:"athl", bonusBase:0, bonusSpe:"", attributs:{ label: "Polyvalente"}},
	{id: 37, name: "Hachette", group:"Haches", associatedComp:"athl", bonusBase:-1, bonusSpe:"", attributs:{ label: "Déf. +1, Secondaire +1"}},
	{id: 38, name: "Hache Longue", group:"Haches", associatedComp:"athl", bonusBase:3, bonusSpe:"force", attributs:{ label: "Encombrante 1, Puissante, Allonge, 2 Mains, Hargneuse"}},
	{id: 39, name: "Pioche", group:"Haches", associatedComp:"athl", bonusBase:1, bonusSpe:"force", attributs:{ label: "Puissante, Lente, 2 Mains"}},
	// Lames Courtes
